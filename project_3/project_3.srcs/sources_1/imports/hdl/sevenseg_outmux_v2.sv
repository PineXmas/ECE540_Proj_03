...
//     );
    ...
    // ==================================================
    // [PROBLEM 3] fix: delay bcd_converter_in
    // ==================================================
    reg		[31:0]	bcd_converter_in_delay;
    always @(posedge clk) begin
        bcd_converter_in_delay <= bcd_converter_in;
    end
    ...
    (
        ...
        .rst_i(reset),
        .start_i(start_conversion),
        .dat_binary_i(bcd_converter_in_delay),
        .dat_bcd_o(bcd_converter_out),
        .done_o(done_conversion)
     );
