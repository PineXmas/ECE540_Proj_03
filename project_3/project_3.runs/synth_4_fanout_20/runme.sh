...
HD_PWD='D:/Projects/Code/ECE540_Proj_03/project_3/project_3.runs/synth_4_fanout_20'
cd "$HD_PWD"
...
EAStep vivado -log Nexys4fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nexys4fpga.tcl
