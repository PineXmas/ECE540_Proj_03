...
HD_PWD='N:/Projects/ECE540_Proj_03/project_3_run_02/project_3.runs/impl_220_v1_run_2'
cd "$HD_PWD"
...
EAStep vivado -log nexys4fpga_v1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nexys4fpga_v1.tcl -notrace
