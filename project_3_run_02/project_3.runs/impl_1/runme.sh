...
HD_PWD='D:/Projects/Code/ece540w20_proj3_r1_1/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nexys4fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nexys4fpga.tcl -notrace
